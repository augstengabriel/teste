...
$smtp.Credentials = New-Object System.Net.NetworkCredential("teste2teste32@hotmail.com", "08866447A");
$smtp.EnableSsl = $true
$Message.From = "teste2teste32@hotmail.com"
$Message.To.Add("rogeg51603@prolug.com")
